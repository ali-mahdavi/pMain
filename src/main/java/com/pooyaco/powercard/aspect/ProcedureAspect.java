package com.pooyaco.powercard.aspect;
...
public class ProcedureAspect {
    ...
    @Pointcut("execution(* com.pooyaco.powercard.aspect.*.*(..)) ")
    public void targetMethods() {
    }

    @Before("@annotation(com.pooyaco.powercard.Procedure)")
    public void preHandle() {
        logger.info("Aspect :: preHandle");
    }

    @AfterReturning(
            pointcut = "@annotation(com.pooyaco.powercard.aspect.Procedure)",
            returning = "retVal")
    public void postHandle(Object retVal) {
        logger.info("Aspect :: postHandle, retVal={}", retVal != null ? retVal.toString() : "null");
    }
    @Around("@annotation(com.pooyaco.powercard.aspect.Procedure)")
