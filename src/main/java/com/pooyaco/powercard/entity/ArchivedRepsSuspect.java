 ...
 */
@Entity
@Table(name = "archived_reps_suspect")
public class ArchivedRepsSuspect extends BaseEntity {
    @Id
    @SequenceGenerator(name = "archived_reps_su_seq")
    @GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "archived_reps_su_seq")
    private long id;
    ...
    public String getuserModeif() {
        return userModif;
    }

    public void setuserModeif(String userModeif) {
        this.userModif = userModeif;
    }
